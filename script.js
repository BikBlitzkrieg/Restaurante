const menuItems = [
    ...
    { name: "Papa a la Huancaína", price: 15, description: "La comodidad en cada plato. Pollo jugoso y tierno, con granos de arroz sueltos y aromáticos. Una receta tradicional que te brinda una experiencia de sabor reconfortante. Nuestro Arroz con Pollo te hará sentir como en casa. ¡Descubre el placer de la cocina casera peruana en cada cucharada!", image: "papa_huancaina.jpg" },
    { name: "Arroz con Pollo", price: 8, description: "Una delicia de texturas y sabores. Papas amarillas suaves y cremosas, cubiertas con una seductora salsa de ají amarillo y queso fresco. Un toque de aceitunas y huevo duro para completar la experiencia. La Papa a la Huancaina te sorprenderá con su combinación única de sabores auténticos. ¡Una entrada irresistible que no querrás dejar de probar!", image: "arroz_pollo.jpg" }
  ];
